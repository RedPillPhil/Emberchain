...
router.post("/exchange/listings/:id/reserve", (req: Request, res: Response): void => {
  try {
...
router.post("/exchange/listings/:id/lock", (req: Request, res: Response): void => {
  try {
...
router.post("/exchange/listings/:id/unlock", (req: Request, res: Response): void => {
  try {
...
router.post("/exchange/listings/:id/commit", async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get("/privacy/ledger", async (req: Request, res: Response): Promise<void> => {
  try {
...
router.post("/call-contract", async (req: Request, res: Response): Promise<void> => {
  try {
...
router.get("/contract-code/:address", async (req: Request, res: Response): Promise<void> => {
  try { res.json({ code: await chain.getContractCode(String(req.params["address"])) }); }
  catch (err) { res.status(400).json({ error: err instanceof Error ? err.message : "Failed" }); }
});

router.post("/submit-transaction", async (req: Request, res: Response): Promise<void> => {
  try {
...
router.post("/submit-raw-evm-tx", async (req: Request, res: Response): Promise<void> => {
  try {
