...
export const LeagueTopBar = memo(() => {
	...
	return (
		<div
			className={`league-top-bar espn-scorebar${
				IS_SAFARI ? " league-top-bar-safari" : ""
			} flex-shrink-0 d-flex overflow-auto small-scrollbar flex-row align-items-stretch`}
		...
		>
			<div className="espn-scorebar-label flex-shrink-0">
			...
			{showLeagueTopBar
				? games2.map((game) => (
						<ScoreBox
							key={game.gid}
							className="espn-score-module flex-shrink-0"
							game={game}
							small
						/>
					))
