...
`,
  ...
  for (const file of [
    ...
    } catch { /* file may not exist in older builds — skip */ }
  }
...
Files:
  ...
  bootstrap-peers.json    — known community nodes (update with each release)
  README.txt              — user instructions
`);
}
